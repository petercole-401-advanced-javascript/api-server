...
app.post('/products', (req, res) => { // write new prod
  stor.products.push(req.body);
  res.status(201).json(stor.products);
});

app.put('/products/:id', (req, res) => { // replace prod by id
  stor.products.forEach((element) => {
    let pile = [];
...
app.delete('/products/:id', (req, res) => { // delete prod by id
...
app.post('/categories', (req, res) => { // write new categories
  ...
  res.status(201).json(stor.categories);
});

app.put('/categories/:id', (req, res) => { // replace categories by id
...
app.delete('/categories/:id', (req, res) => { // delete categories by id
